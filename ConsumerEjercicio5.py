...
# conectando a hive
        ...
        # Convert RDD[String] to RDD[Row] to DataFrame
            ...
            keywordDataFrame = spark.sql("select keywordt, count(*) as total, current_timestamp() as timestamp from keywordts group by keywordt order by total desc limit 3")
            keywordDataFrame.show()
            keywordDataFrame.write.mode("append").saveAsTable("keywordt5")
